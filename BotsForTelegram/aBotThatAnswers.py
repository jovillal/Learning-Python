...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 14 09:55:42 2023

create an echo bot that will be listening to all the messages sent by the user. 
Read the last message  and send the same message with the format You send me {MESSAGE_TEXT} message.
...
if __name__ == "__main__":
    tg = TelegramEcho("6365315898:AAHkH7qUed2dMVQ-Mj9JSyEwYlLIgoZzIzg")
    tg.run()
